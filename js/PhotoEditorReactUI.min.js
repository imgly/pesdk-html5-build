 ...
 */
O.prototype.identifier="react",O.BaseComponent=p.BaseComponent,O.BaseControls=x["default"],O.ControlsComponent=g["default"],O.React=p.React,O.ReactBEM=p.ReactBEM,O.SharedState=p.SharedState,O.Constants=p.Constants,O.Utils=p.Utils,O.ScrollbarComponent=m["default"],O.ModalManager=y["default"],O.JSONLoader=E["default"],O.PhotoRoll=S,O.Controls=w,O.SliderComponent=P["default"],O.SliderOverlayComponent=D["default"];var T=function(t){function e(){(0,a["default"])(this,e);for(var n=arguments.length,o=Array(n),r=0;r<n;r++)o[r]=arguments[r];var i=(0,l["default"])(this,t.call.apply(t,[this].concat(o)));return i._ui=new O(i.props),i}return(0,c["default"])(e,t),e.prototype.render=function(){return this._ui.render()},e}(p.React.Component);O.ReactComponent=T,p.SDK.UI=p.SDK.UI||{},p.SDK.UI.ReactUI=O,t.exports=O}])});