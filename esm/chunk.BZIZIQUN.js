import{A as Po,a as U,g as xr,h as tt,l as M,m as Cr,p as J,q as Kr,r as ot,s as E,t as Mr,u as rt,w as et,x as yr,y as Rt,z as Fr}from"./chunk.XVFO22UQ.js";import{C as Pe,H as pe,P as No,S as It,_ as co,a as qo,aa as Ur,c as zo,ca as q,da as k,ea as Jo,fa as s,ha as m,ja as Yr,ka as d,la as qr,p as N}from"./chunk.47HGVUKA.js";import{I as O,c as H,d as c,h as u,s as x}from"./chunk.6QXMKAVR.js";import Ho from"react";import{ThemeProvider as Xr}from"styled-components";function Rr(o){return!Object.prototype.hasOwnProperty.call(o,"name")}function on(o){return!Object.prototype.hasOwnProperty.call(o,"name")}var ct=class{};var ut=class{};var Ct=class{constructor(e){this.name=e.name,this.coverImageUrl=e.coverImageUrl}loadCoverImage(e="anonymous"){return new Promise((t,i)=>{let r=new Image;r.addEventListener("load",()=>{t(r)}),r.addEventListener("error",()=>{i(new Error(`Failed to load image at ${this.coverImage}`))}),r.crossOrigin=e,r.src=this.coverImageUrl,this.coverImage=r})}};var ft=class{constructor(e){this.title=e.title,this.category=e.category||e.title,this.thumbUrl=e.thumbUrl,this.rawUrl=e.rawUrl,this.authorName=e.authorName,this.authorAvatar=e.authorAvatar}loadThumbImage(e="anonymous"){return new Promise((t,i)=>{let r=new Image;r.addEventListener("load",()=>{t(r)}),r.addEventListener("error",()=>{i(new Error(`Failed to load image at ${this.thumbUrl}`))}),r.crossOrigin=e,r.src=this.thumbUrl,this.thumbImage=r})}getThumbImage(){return this.thumbUrl}};var Mo=class{getData(e){return new Promise((t,i)=>{let r=new XMLHttpRequest;r.open("GET",e,!0),r.responseType="json",r.onload=()=>{let{status:p}=r;p===200?t(r.response):i(new Error(`HTTP Status ${p}`))},r.send()})}},ht=Mo;var bt=class{loadJSON(e){return new ht().getData(e)}getCategories(){return Promise.resolve([])}searchImages(e){return Promise.resolve([])}};import xt from"react";import gt from"react";import vt from"styled-components";var St=vt(co)`
...
`,yt=t=>{var{isActive:o}=t,e=It(t,["isActive"]);return gt.createElement(St,O({},e))},Qo=yt;import Tt from"styled-components";var Zo=Tt(co)`
...
`;import At from"styled-components";var Ro=At(co)`
...
`;var uo=o=>{let e=o.type===x.LARGE,t=o.type===x.SMALL,i=Zo;return e?i=Qo:t&&(i=Ro),xt.createElement(i,O({},o))};import kt from"styled-components";var yo=kt.div.attrs(o=>({"data-test":o["data-test"]||k.CardContainer}))`
  display: flex;
  flex-wrap: wrap;
  /* width - padding on both sides */
  width: ${o=>o.theme.measurements.advancedUIToolControlBar.width-48}px;
`;import Et from"react";import Ut,{css as oe}from"styled-components";var Ft=Ut.div`
  display: flex;
  ...
  ${o=>o.reverse?oe`
        ...
        `}
`,ee=({reverse:o=!1,children:e})=>Et.createElement(Ft,{"data-test":k.ToolControlBar,reverse:o},e);import Bt,{css as _o}from"styled-components";var te=Bt.div.attrs(()=>({"data-test":k.CategoryItemsContainer}))`
  ...
  ${({show:o})=>o&&_o`
      ...
      ${N()?_o`
          ...
          `}
    `}
`;import To from"react";import re,{css as Lt}from"styled-components";var Ot=re.div`
  position: relative;
  flex-grow: 0;
  flex-shrink: 0;
  ${o=>o.shouldAnimateHeight&&Lt`
      height: ${o.height}px;
    `}
  opacity: ${({opacity:o})=>o};
...
`,jo=class extends To.Component{constructor(e){super(e);this.contentRef=null;this.enableOverflow=()=>{let{show:e}=this.props;e&&this.contentRef.current&&this.setState({overflow:!0})};this.contentRef=To.createRef(),this.state={height:0,mounted:!1,overflow:!1}}componentDidMount(){let{overflowAfterExpand:e}=this.props;this.contentRef.current&&(e&&this.contentRef.current.addEventListener("transitionend",this.enableOverflow),this.setState({height:this.contentRef.current.scrollHeight,mounted:!0}))}componentWillUnmount(){this.contentRef.current&&this.contentRef.current.removeEventListener("transitionend",this.enableOverflow)}render(){let{show:e,shouldAnimateOverflow:t,shouldAnimateHeight:i,children:r}=this.props,{height:p,mounted:l,overflow:f}=this.state,b=l&&(e&&t||!t),h=b?p:0,v=b?1:0,C=b?"visible":"hidden";return To.createElement(Ot,{"data-test":k.ToolControlBarControls,ref:this.contentRef,height:h,opacity:v,visibility:C,overflow:f?"visible":"hidden",shouldAnimateHeight:i,shouldAnimateOverflow:t},To.createElement(wt,null,r))}};jo.defaultProps={show:!0,shouldAnimateOverflow:!0,shouldAnimateHeight:!0};var ne=jo;import Dt,{css as Pt}from"styled-components";var Go=Dt(No)`
  position: relative;
  padding: ${o=>o.theme.measurements.advancedUIToolControlBar.padding};
  width: ${o=>o.theme.measurements.advancedUIToolControlBar.width}px;
  ...
  ${()=>N()||zo()?Pt`
      ...
      `:""}
`;Go.defaultProps={direction:"vertical"};import $t,{css as Ht}from"styled-components";var Mt=$t.div`
  &:after {
    content: '';
    position: absolute;
    bottom: 0px;
...
`,Ao=Mt;import _t from"styled-components";var jt=_t.h2`
...
`,ie=({name:o,isFirstCategory:e,isLastCategory:t,children:i})=>Y.createElement(zt,null,!e&&Y.createElement(s.Spacer,{count:2}),Y.createElement(xo,{"data-test":o},o),Y.createElement(yo,{"data-test":k.CategoryItemsContainer},i),!t&&Y.createElement(Y.Fragment,null,Y.createElement(s.Spacer,{count:2}),Y.createElement(Ao,{full:!0})));import Gt from"styled-components";var Wt=Gt.h1`
  ...
  font-weight: 500;
  text-align: center;
`,se=Wt;import ae from"react";import Yt,{css as Wo}from"styled-components";var Xt=Yt.div`
  display: flex;
  flex: 1 0 auto;
  flex-direction: column;
  align-items: center;
...
`,me=({reverse:o,children:e})=>ae.createElement(Xt,{reverse:o,"data-test":k.Toolbar},ae.createElement(No,{direction:"vertical"},e));import le from"react";import de,{css as Yo}from"styled-components";var Kt=de(pe)`
  width: inherit;
  height: inherit;
  padding: 0;
  margin: 0;
  ...
  ${o=>o.isActive&&Yo`
    ...
    `}
`,Vt=de.li.attrs({"aria-haspopup":!0,"aria-hidden":!0,role:"menuitem"})`
  height: ${o=>o.theme.measurements.advancedUIToolbar.itemHeight}px;
  cursor: pointer;
  position: relative;
`,ce=o=>le.createElement(Vt,null,le.createElement(Kt,O(O({},o),{"data-test":k.ToolbarItem})));import qt from"styled-components";var Jt=qt.li.attrs({role:"none"})`
  height: ${o=>o.theme.measurements.advancedUIToolbar.seperatorHeight}px;
  cursor: pointer;
  position: relative;
`,ue=Jt;import Ce from"react";import fe,{css as Co}from"styled-components";var Qt=fe.div`
  ${N()?Co`
...
`,Or=Oo(s.Input.Selection)`
  width: 50%;
`,wr=({textTool:o,custom:e})=>{let t=o.locale.controls,i=o.localeColor.colorPicker,{fontFamilies:r,alignment:p,isTextSelected:l,fontFamily:f,fontStyle:b,fontWeight:h,colorList:v,backgroundColorList:C}=o,g=["left","center","right"],a=e.getButton("textAlignment"),S=e.getButton("toolControlBarPrimaryButton"),A=()=>{o.toolSnapshot()},K=()=>{o.add()},V=y=>{let po=y?parseFloat(y):0;o.setFontSize(Math.max(10,Math.min(690,po)))},ro=()=>g.map(y=>{let po=Fr[y];return T.createElement(a,{tool:y,isDisabled:!l,ariaLabel:`Align ${y}`,isActive:y===p,key:y,style:{padding:"1px 3px 2px"},icon:T.createElement(po,null),onClick:()=>o.changeAlignment(y)})}),W=r.map(y=>({label:`${y.fontFamily} ${Ur.getDisplayFontStyle(y)}`,fontWeight:y.fontWeight,fontStyle:y.fontStyle,fontFamily:y.fontFamily,value:y.identifier})),no=W.filter(({value:y})=>y===o.identifier)[0];return T.createElement(n.Controlsbar,{show:!0,overflowAfterExpand:!0,shouldAnimateHeight:!1},T.createElement(s.Input.Form,null,T.createElement(S,{tool:c.TEXT,ariaLabel:t.buttonNew,onClick:K,fullWidth:!0,label:t.buttonNew}),T.createElement(s.Spacer,{count:2}),T.createElement(s.Input.Dropdown,{isDisabled:!l,style:{fontFamily:f,fontStyle:b,fontWeight:h},itemStyle:y=>({fontFamily:y.fontFamily,fontStyle:y.fontStyle,fontWeight:y.fontWeight}),label:t.dropdownFontFamily,list:W,onSelect:o.changeFont,selectedItem:no.label}),T.createElement(s.Spacer,{count:2}),T.createElement(Br,null,T.createElement(Lr,{value:o.fontSize.toFixed(0),onSubmit:V,label:t.textFontSize,isDisabled:!l}),T.createElement(Or,{isDisabled:!l,inline:!0,label:t.selectAlignment,"data-test":k.TextAlignment},ro())),T.createElement(s.Spacer,{count:2}),T.createElement(We,null,T.createElement(n.ItemsSeparator,{full:!0})),T.createElement(s.Spacer,{count:2}),T.createElement(s.Input.Selection,{isDisabled:!l,label:t.selectFontColor},T.createElement(M,{activeSprite:o.id,activeColor:o.textColor,colors:v,labelsColor:i,isDisabled:!l,onChange:o.changeColor,onAddSnapshot:o.colorSnapshot})),T.createElement(s.Spacer,{count:2}),T.createElement(s.Input.Selection,{isDisabled:!l,label:t.selectBackgroundColor},T.createElement(M,{activeSprite:o.id,activeColor:o.backgroundColor,colors:C,labelsColor:i,isDisabled:!l,onChange:o.changeBackgroundColor,onAddSnapshot:o.backgroundColorSnapshot})),T.createElement(s.Spacer,{count:2}),T.createElement(We,null,T.createElement(n.ItemsSeparator,{full:!0})),T.createElement(s.Spacer,{count:2}),T.createElement(s.Input.Slider,{isDisabled:!l,label:t.sliderLineSpacing,value:o.lineHeight,min:.5,max:3,onChange:o.changeLineHeight,onMouseUp:A,onTouchEnd:A,snap:1,divider:1,decimal:1}),T.createElement(s.Spacer,{count:1})))},Ye=d("textTool","custom")(m(wr));var Dr=({textTool:o,displayTitle:e})=>wo.createElement(wo.Fragment,null,e&&wo.createElement(n.Sidebar.Heading,null,o.locale.title),wo.createElement(Ye,null)),Xe=d("textTool")(m(Dr));import vo from"react";import z from"react";var Pr=({textDesignTool:o,custom:e})=>{let t=o.locale.controls,i=o.localeColor.colorPicker,{colorList:r}=o,p=o.isTextDesignSelected,l=e.getButton("toolControlBarPrimaryButton"),f=e.getButton("toolControlBarSecondaryButton"),b=()=>{o.add()},h=()=>{o.changeSeed()};return z.createElement(n.Controlsbar,{shouldAnimateOverflow:!1,shouldAnimateHeight:!1},z.createElement(s.Input.Form,null,z.createElement(l,{tool:c.TEXT_DESIGN,ariaLabel:t.buttonNew,onClick:b,fullWidth:!0,label:t.buttonNew}),z.createElement(s.Spacer,{count:2}),z.createElement(f,{tool:c.TEXT_DESIGN,ariaLabel:t.buttonShuffle,isDisabled:!p,onClick:h,fullWidth:!0,label:t.buttonShuffle}),z.createElement(s.Spacer,{count:2}),z.createElement(s.Input.Selection,{isDisabled:!p,label:t.selectColor},z.createElement(M,{activeSprite:o.id,activeColor:o.color,colors:r,labelsColor:i,isDisabled:!p,onChange:o.changeColor,onAddSnapshot:o.colorSnapshot}))),z.createElement(n.ItemsSeparator,null))},Ke=d("textDesignTool","custom")(m(Pr));import Do from"react";var $r=({textDesignTool:o,custom:e})=>{let{items:t,identifier:i}=o,r=l=>{o.changeIdentifier(l)},p=(l,f)=>{let b=e.getAdvancedItemCard();return Do.createElement(b,{key:l.identifier,tool:c.TEXT_DESIGN,type:x.MEDIUM,onClick:()=>r(l.identifier),image:l.thumbnailURI,label:l.name||"",style:{animationDelay:`${U(f)}s`,backgroundSize:"60%"},isDisabled:!o.isTextDesignSelected,isActive:i===l.identifier},Do.createElement(E,{hidden:!0},l.name))};return Do.createElement(n.Itemsbar,null,Do.createElement(n.CardContainer,null,t.map(p)))},Ve=d("textDesignTool","custom")(m($r));var Hr=({textDesignTool:o,displayTitle:e})=>vo.createElement(vo.Fragment,null,e&&vo.createElement(n.Sidebar.Heading,null,o.locale.title),vo.createElement(Ke,null),vo.createElement(Ve,null)),qe=d("textDesignTool")(m(Hr));import to from"react";import G from"react";var _r=({transformTool:o,custom:e})=>{let t=o.locale.controls,{forceDimensions:i,lockResolution:r,localOutputHeight:p,localOutputWidth:l}=o,f=e.getButton("toolControlBarSecondaryButton"),b=()=>{o.reset()},h=e.getCheckbox();return G.createElement(n.Controlsbar,{shouldAnimateHeight:!1},G.createElement(s.Input.Form,null,G.createElement(f,{tool:c.TRANSFORM,ariaLabel:t.buttonReset,onClick:b,fullWidth:!0,label:t.buttonReset}),G.createElement(s.Spacer,{count:2}),G.createElement(h,{isDisabled:i,value:r,label:t.checkboxKeepResolution,checkMarkPosition:"right",onClick:o.changeLockResolution,style:{paddingTop:"5px",justifyContent:"space-between"}}),G.createElement(s.Spacer,{count:2}),G.createElement(Mr,{isDisabled:i,showLabel:!0,valueHeight:p,valueWidth:l,onSubmitWidth:o.onPixelWidth,onSubmitHeight:o.onPixelHeight,label:t.inputCropSize,labelHeight:t.inputHeight,labelWidth:t.inputWidth}),G.createElement(s.Spacer,{count:1})),G.createElement(n.ItemsSeparator,null))},Je=d("transformTool","custom")(m(_r));import L from"react";import{renderToStaticMarkup as Qe}from"react-dom/server";var jr=({transformTool:o,custom:e,editor:t})=>{let{categories:i,items:r,identifier:p,config:l,locale:f}=o,b=e.getAdvancedItemCard(),h=e.getAdvancedCategoryCard(),v=(a,S)=>{let{theme:A,measurements:K}=t.configStore,V=f.items[a.identifier]||a.name,ro=a.thumbnailURI||"",W="80%";if(!o.checkIfTransformThumbnailExits(a.thumbnailURI)){let no=a.identifier.includes("imgly_transform_common"),y=Po.crops[a.identifier]||Po.crops.imgly_transform_common_custom,po=L.createElement(y,{width:K.advancedCard.medium.width-(no?42:0),height:K.advancedCard.medium.height-(no?42:0),main:A.transform.crops.main,highlight:A.transform.crops.highlight,shadow:A.transform.crops.shadow});ro=`'data:image/svg+xml,${encodeURIComponent(Qe(po))}'`,W=N()||zo()?"auto":"unset"}return L.createElement(b,{key:a.identifier,tool:c.TRANSFORM,type:x.MEDIUM,onClick:()=>o.changeIdentifier(a.identifier,!0),image:ro,label:V,style:{backgroundSize:W,animationDelay:`${U(S)}s`},isActive:a.identifier===p},L.createElement(E,null,V))},C=(a,S)=>{let{theme:A,measurements:K}=t.configStore,V=o.selectedCategoryIdentifier===a.identifier,ro=f.categories[a.identifier]||a.name,W=a.thumbnailURI||"";if(!a.items)return null;if(!o.checkIfTransformThumbnailExits(a.thumbnailURI)){let no=Po.categories[a.identifier]||Po.crops.imgly_transform_common_custom,y=L.createElement(no,{width:K.advancedCard.large.width-42,height:K.advancedCard.large.height-42,main:A.transform.crops.main,highlight:A.transform.crops.highlight,shadow:A.transform.crops.shadow});W=`'data:image/svg+xml,${encodeURIComponent(Qe(y))}'`}return L.createElement("div",{key:a.identifier},L.createElement(h,{type:x.LARGE,onClick:()=>o.toggleCategorySelection(a.identifier),key:a.identifier,image:W,style:{animationDelay:`${U(S)}s`},label:a.name,tool:c.TRANSFORM},L.createElement(E,{caret:!0,isActive:V},ro)),L.createElement(n.Sidebar.ExpandableContainer,{show:V},a.items.map(v)))},g=(a,S)=>{let A=f.categories[a.identifier]||a.name;return a.items?L.createElement(n.Sidebar.TextCategory,{key:a.identifier,name:A,isFirstCategory:S===0,isLastCategory:S===i.length-1},a.items.map(v)):null};return l.flattenCategories?L.createElement(L.Fragment,null,r.map(v)):l.categoryHeaderType===H.CARD?L.createElement(L.Fragment,null,i.map(C)):l.categoryHeaderType===H.TEXT?L.createElement(L.Fragment,null,i.map(g)):null},Ze=d("transformTool","custom","editor")(m(jr));var Nr=({transformTool:o,displayTitle:e})=>to.createElement(to.Fragment,null,e&&to.createElement(n.Sidebar.Heading,null,o.locale.title),to.createElement(Je,null),to.createElement(n.Itemsbar,null,to.createElement(n.CardContainer,null,to.createElement(Ze,null)))),Re=d("transformTool")(m(Nr));var mo=class extends I.Component{render(){let{config:e,active:t}=this.props,i=t.tool,r=e.config.displayToolControlBarTitle;return I.createElement(n.Sidebar.Index,{reverse:e.config.order==="reverse"},I.createElement(s.Switch.Index,{type:i},I.createElement(s.Switch.Case,{value:c.LIBRARY},I.createElement(He,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.FILTER},I.createElement(Ee,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.FOCUS},I.createElement(Be,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.ADJUSTMENT},I.createElement(Ie,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.OVERLAY},I.createElement(je,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.STICKER},I.createElement(Ge,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.TEXT},I.createElement(Xe,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.TEXT_DESIGN},I.createElement(qe,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.FRAME},I.createElement(we,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.BRUSH},I.createElement(Te,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.TRANSFORM},I.createElement(Re,{displayTitle:r})),I.createElement(s.Switch.Case,{value:c.CUSTOM},I.createElement(Ae,{displayTitle:r}))))}};mo=q([d("active","config"),m],mo);var nt=zr.div`
  position: absolute;
  height: 100%;
